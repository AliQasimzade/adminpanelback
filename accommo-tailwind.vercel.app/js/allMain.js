      ...
      geocoder.geocode(
          ...
          (results, status) => {
              if (status === "OK") {
                  ...
                  addresss.innerHTML = results[0].formatted_address.split(',')[0] + "," + findType[0] + "," + results[0].formatted_address.split(',')[1] + "," + results[0].formatted_address.split(',')[2];

                  street.innerHTML = results[0].formatted_address.split(',')[0];
          ...
          geocoder.geocode(
              ...
              (results, status) => {
                  if (status === "OK") {
                      ...
                      console.log(findType);
                      street.innerHTML = results[0].formatted_address.split(',')[0]
                      addresss.innerHTML = results[0].formatted_address.split(',')[0] + "," + findType[0] + "," + results[0].formatted_address.split(',')[1] ;
  ...
  function loadMap() {
    if (findListingById) {
            ...
            const location = {
                ...
                lng: findListingById.locationCoords.longtitude,
            };
