...
const getProperties = async()=>{
    let req = await fetch("https://restwell.az/api/properties")
...
//  update
  const updateProperty = async () => {
    if (updateName.value == findPropertyById.name && updateFeatureIcon.value == findPropertyById.icon ) {
      ...
      try {
        ...
        const request = await fetch(`https://restwell.az/api/updateproperty/${findId}`, {
          method: "PUT",
          headers: {
  ...
  async function deleteElement(id){
    try {
      console.log(id);
    const request = await fetch(`https://restwell.az/api/deleteProperty/${id}`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json"
    },
