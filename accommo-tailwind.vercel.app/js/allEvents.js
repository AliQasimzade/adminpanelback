...
const getData = async () => {
  let req = await fetch("https://restwell.az/api/events")
...
const updateEvent = async () => {
  try {
    ...
    if (updateName.value == '' ||
      ...
      const request = await fetch(`https://restwell.az/api/updateevent/${findId}`, {
        method: "PUT",
        headers: {
...
async function deleteEvent(id) {
  try {
    const req = await fetch(`https://restwell.az/api/deleteevent/${id}`, {
      method:"DELETE",
      headers: {
        "Content-Type":"application/json"
      }
