...
const getAllLocations = async () => {
    try {
        const req = await fetch('https://restwell.az/api/locations')
        if (!req.ok) {
...
const updateLocation = async () => {
    try {
        if (updateLocName.value == '' || getLocImageUrl == '') {
            ...
            const req = await fetch(`https://restwell.az/api/updatelocation/${findId}`, {
                method: 'PUT',
                headers: {
...
async function deleteLocation(id) {
    try {
        const req = await fetch(`https://restwell.az/api/deletelocation/${id}`, {
            method: 'DELETE',
