...
const getCategories = async () => {
  let req = await fetch("https://restwell.az/api/categories")
...
const updateCategory = async () => {
  ...
  if (updateName.value === findCategoryById.name &&
    ...
    try {
      ...
      const request = await fetch(`https://restwell.az/api/updatecategory/${findId}`, {
        method: "PUT",
        headers: {
...
async function deleteElement(id) {
  try {
    console.log(id);
    const request = await fetch(`https://restwell.az/api/deletecategory/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json"
      },
