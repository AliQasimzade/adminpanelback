(()=>{
    ...
    function Xe(e) {
        ...
        for (let o of r)
            if (!t.includes(o) && (Kt.forEach(s=>s(o)),
            o._x_cleanups))
...
` : ""}`, t),
    ...
    function kn(e, t, r) {
        [null, void 0, !1].includes(r) && Ln(t) ? e.removeAttribute(t) : (xr(t) && (r = t),
        $n(e, t, r))
    }
    function $n(e, t, r) {
    ...
    function T(e, t, r) {
        ...
        i.has(M) || (i.add(M),
        M.deps.push(i),
        M.options.onTrack && M.options.onTrack({
            effect: M,
            target: e,
            type: t,
            key: r
    ...
    function j(e, t, r, n, i, o) {
        ...
        if (t === "clear")
            ...
            t) {
            case "add":
                L(e) ? De(r) && c(s.get("length")) : (c(s.get(U)),
                X(e) && c(s.get(At)));
                break;
            case "delete":
                L(e) || (c(s.get(U)),
    ...
    function $e(e=!1, t=!1) {
        return function(n, i, o) {
            ...
            return (ke(i) ? $r.has(i) : Jn(i)) || (e || T(n, "get", i),
            t) ? a : Tt(a) ? !s || !De(i) ? a.value : a : ue(a) ? e ? Fr(a) : je(a) : a
        }
    }
    var ni = Br()
      , ii = Br(!0);
    function Br(e=!1) {
        return function(r, n, i, o) {
            ...
            return r === _(o) && (a ? Et(i, s) && j(r, "set", n, i, s) : j(r, "add", n, i)),
            c
        }
    }
    function oi(e, t) {
        ...
        return i && r && j(e, "delete", t, void 0, n),
        i
    }
    function si(e, t) {
        let r = Reflect.has(e, t);
        return (!ke(t) || !$r.has(t)) && T(e, "has", t),
        r
    }
    function ai(e) {
        return T(e, "iterate", L(e) ? "length" : U),
        Reflect.ownKeys(e)
    }
    var Kr = {
        get: Zn,
    ...
    function Vr(e) {
        e = _(e);
        let t = _(this);
        return Fe(t).has.call(t, e) || (t.add(e),
        j(t, "add", e, e)),
        this
    }
    function qr(e, t) {
    ...
    function Wr() {
        let e = _(this)
          ...
          , n = e.clear();
        return t && j(e, "clear", void 0, void 0, r),
        n
    }
    function Ve(e, t) {
        return function(n, i) {
    ...
    x("data", e=>xe(e));
    x("root", e=>V(e));
    x("refs", e=>(e._x_refs_proxy || (e._x_refs_proxy = D(pi(e))),
    e._x_refs_proxy));
    function pi(e) {
        let t = []
          , r = e;
    ...
    function gi(e, t) {
        ...
        e[`${s}Key`])).length === i.length && nn(e.key).includes(r[0]))
    }
    function nn(e) {
        if (!e)
            return [];
