...
const getBanners = async () => {
  let req = await fetch("https://restwell.az/api/banners")
...
const updateBanner = async () => {
  ...
  if (getIconUrl == findBannerById.image) {
    ...
    try {
      ...
      const request = await fetch(`https://restwell.az/api/updatebanner/${findId}`, {
        method: "PUT",
        headers: {
...
async function deleteElement(id) {
  try {
    console.log(id);
    const request = await fetch(`https://restwell.az/api/deletebanner/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json"
      },
